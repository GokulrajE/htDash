...
const FILTER_STATUS_MAP = {
  all:               ['unassigned', 'inactive', 'active', 'training_completed', 'a1_completed', 'all_completed', 'pre_discontinued', 'discontinued'],
...
function updateFilterCounts() {
  const counts = { all: 0, unassigned: 0, inactive: 0, active: 0, training_completed: 0, a1_completed: 0, all_completed: 0, pre_discontinued: 0, discontinued: 0 };
